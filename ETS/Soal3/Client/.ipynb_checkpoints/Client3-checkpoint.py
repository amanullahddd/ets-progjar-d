...
server_address = ('172.16.16.104', 13000)
...
def getdatapemain_multithread(total_request,  proportion_data):
    total_response = 0
    texec = dict()
...
if __name__ == '__main__':
    ...
    for request in total_request:
        getdatapemain_multithread(request,  proportion_data)
        
    porportion_header = ["Jumlah Thread", "Jumlah Request", "Jumlah Response", "Waktu", "Average Latency"]
